...
const guides = [
  ...
  },
  {
    ...
    description: 'Deploy UI + Engine for production — Docker, PM2, Nginx, tenant API auth configuration.',
    color: 'red',
  },
  {
    id: 'config-guide',
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500">Documentation and setup instructions for the Bot Platform</p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium ${c.badge} shrink-0 ml-4`}>
                  {guide.audience}
                </span>
              </div>
            </Link>
