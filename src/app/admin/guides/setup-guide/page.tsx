  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <h1 className="text-xl font-bold text-gray-900 mt-2">Application Setup Guide</h1>
        <p className="text-sm text-gray-500">For admins and DevOps — how to install, deploy, and maintain the platform</p>
        ...
        <Section title="Prerequisites">
          <div className="grid grid-cols-2 gap-3 text-sm text-gray-600">
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              ...
              <div className="text-xs text-gray-500">Next.js (3000) + Mock API (8080)</div>
            </div>
          </div>
        </Section>
...
npm install`}</CmdBlock>
          ...
          <p className="text-sm text-gray-600">
            This installs Next.js, React, NLP libraries (@nlpjs/nlp, fuse.js), and all other dependencies.
          </p>
        </Section>
...
# API_TOKEN=prod-bearer-token`}</pre>
          ...
          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-xs text-yellow-800">
            <span className="font-medium">Note:</span> For local development, <Code>API_BASE_URL</Code> points to the mock API server at port 8080.
            In production, update this to your real API endpoint.
          </div>
        </Section>
        ...
        <Section title="3. Running in Development">
          <div className="space-y-4">
            <div>
              <div className="text-sm font-medium text-gray-700 mb-1">Option A: Full stack (recommended)</div>
              <CmdBlock>{`# Starts both Mock API (port 8080) and Next.js (port 3000)
npm run dev:full`}</CmdBlock>
            </div>

            <div>
              <div className="text-sm font-medium text-gray-700 mb-1">Option B: Separately</div>
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-gray-50">
                  <th className="text-left px-3 py-2 font-medium text-gray-600">Command</th>
              ...
              <tbody className="text-gray-600">
                <tr className="border-t border-gray-100">
                  ...
                  <td className="px-3 py-2">Start Next.js dev server (port 3000)</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="px-3 py-2 font-mono">npm run mock-api</td>
                  <td className="px-3 py-2">Start mock API server (port 8080)</td>
                </tr>
                <tr className="border-t border-gray-100">
...
npm run start:prod`}</CmdBlock>
          ...
          <div className="space-y-2 text-sm text-gray-600">
            <div className="flex gap-2">
              ...
              Set <Code>API_BASE_URL</Code> to your production API endpoint in <Code>.env.local</Code> or environment variables.
            </div>
            <div className="flex gap-2">
              <span className="text-green-500 shrink-0">2.</span>
              Set <Code>API_TOKEN</Code> to a valid bearer token for API authentication.
            </div>
            <div className="flex gap-2">
            ...
            <div className="flex gap-2">
              ...
              Configure a process manager (PM2, systemd) to keep the server running.
            </div>
            <div className="flex gap-2">
        ...
        <Section title="7. Mock API Server">
          <p className="text-sm text-gray-600 mb-3">
            The mock API server simulates production APIs for development. It runs on <Code>http://localhost:8080</Code>.
          </p>

          <div className="grid grid-cols-2 gap-4 text-xs text-gray-600 mb-3">
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="font-medium text-gray-700 mb-1">Query Definitions</div>
              <div><FileRef path="mock-api/db.json" /> — All queries, filters, and stats</div>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="font-medium text-gray-700 mb-1">API Handlers</div>
              <div><FileRef path="mock-api/server.js" /> — Custom endpoint handlers with sample data</div>
            </div>
          </div>

          <p className="text-xs text-gray-500">
            The mock server supports path variables, query params, and request body filters — matching how real APIs work.
          </p>
        </Section>
        ...
        <Section title="8. Key Configuration Files">
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              ...
              <tbody className="text-gray-600">
                <tr className="border-t border-gray-100">
                  <td className="px-3 py-2"><FileRef path="src/config/groups.json" /></td>
                  <td className="px-3 py-2">Group definitions (bots, sources, templates, NLP data)</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="px-3 py-2"><FileRef path="src/config/filter-config.json" /></td>
                  <td className="px-3 py-2">Filter UI schema (date range, region, team, etc.)</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="px-3 py-2"><FileRef path="src/config/users.json" /></td>
                  <td className="px-3 py-2">Admin user accounts</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="px-3 py-2"><FileRef path="src/config/settings.json" /></td>
                  <td className="px-3 py-2">Platform settings (thresholds, cache, platforms)</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="px-3 py-2"><FileRef path="src/training/corpus.json" /></td>
                  <td className="px-3 py-2">NLP intent + entity training data</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="px-3 py-2"><FileRef path="src/training/faq.json" /></td>
                  <td className="px-3 py-2">Fuzzy match FAQ entries</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="px-3 py-2"><FileRef path="src/core/constants.ts" /></td>
                  <td className="px-3 py-2">NLP thresholds, session TTL, cache TTL</td>
                </tr>
                <tr className="border-t border-gray-100">
        ...
        <Section title="9. Troubleshooting">
          <div className="space-y-3">
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="text-xs font-medium text-gray-700">Bot returns &quot;I&apos;m not sure I understand&quot;</div>
              <div className="text-xs text-gray-500 mt-1">
                The NLP confidence is below threshold. Add more training phrases in Admin &rarr; Intents, or add FAQ entries for fuzzy matching. Check confidence scores in Admin &rarr; Test Console.
              </div>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="text-xs font-medium text-gray-700">Query returns &quot;could not fetch data&quot;</div>
              <div className="text-xs text-gray-500 mt-1">
                The mock API server is not running. Start it with <Code>npm run mock-api</Code> or use <Code>npm run dev:full</Code>.
              </div>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="text-xs font-medium text-gray-700">NLP model not classifying correctly</div>
              <div className="text-xs text-gray-500 mt-1">
                Restart the dev server to retrain the model. The NLP model trains on startup from corpus.json.
                Run <Code>npm run evaluate</Code> to check accuracy metrics.
              </div>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="text-xs font-medium text-gray-700">Widget not loading in external app</div>
              <div className="text-xs text-gray-500 mt-1">
                Check that the widget script URL is accessible from the host app. Verify CORS settings. Ensure the <Code>ChatbotWidgetConfig.group</Code> matches a valid group ID.
              </div>
            </div>
          </div>
        </Section>
